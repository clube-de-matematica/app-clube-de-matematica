...
class _FiltroOpcoesPageState extends State<FiltroOpcoesPage> {
  _FiltroOpcoesPageState(TiposFiltro tipo): controller = FiltroOpcoesController(
    tipo: tipo,
  ...
  final ThemeData tema = Modular.get<MeuTema>().temaClaro;
  ...
  Widget _opcaoTipoAssunto(OpcaoFiltroAssuntoUnidade unidade) {
    ...
    if (subItens.isEmpty) {
      ...
      return ExpansionTilePersonalizado(
        tilePadding: padding,
        backgroundColor: tema.primaryColor.withOpacity(0.07),
        leading: leading,
        trailing: trailing,
        title: title,
        children: subItens,
        titleTextColor: Colors.black.withOpacity(0.8),
      );
    }
  }
