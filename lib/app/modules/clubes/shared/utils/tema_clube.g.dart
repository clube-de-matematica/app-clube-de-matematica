...
mixin _$TemaClube on _TemaClubeBase, Store {
  Computed<MaterialColor>? _$amostraPrincipalComputed;

  @override
  MaterialColor get amostraPrincipal => (_$amostraPrincipalComputed ??=
          Computed<MaterialColor>(() => super.amostraPrincipal,
              name: '_TemaClubeBase.amostraPrincipal'))
      .value;
  ...
  String toString() {
    return '''
amostraPrincipal: ${amostraPrincipal},
tema: ${tema},
brilho: ${brilho},
primaria: ${primaria},
